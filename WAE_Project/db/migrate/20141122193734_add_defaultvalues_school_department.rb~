class AddDefaultvaluesSchoolDepartment < ActiveRecord::Migration
  def self.up
	School.create id:'1', schoolname: 'School of Engineering and Technology', description: 'SET'
	School.create id:'2', schoolname: 'School of Environment, Resources and Development', description: 'SERD'
	School.create id:'3', schoolname: 'School of Management', description: 'SOM'
